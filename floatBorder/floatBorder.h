...
#define FLOAT_BORDER_GET_CLASS(obj) (G_TYPE_INSTANCE_GET_CLASS((obj),TYPE_FLOAT_BORDER,FloatBorderClass))
#define FLOAT_BORDER_GET_PRIV(obj) (G_TYPE_INSTANCE_GET_PRIVATE((obj),TYPE_FLOAT_BORDER,FloatBorderPriv))
